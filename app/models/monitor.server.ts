...
const updateMonitorResultValidator =
	Prisma.validator<Prisma.MonitorDefaultArgs>()({
		select: {
			id: true,
			drives: {
				select: {
...
export type UpdateMonitorResult = Prisma.MonitorGetPayload<
	typeof updateMonitorResultValidator
>;
